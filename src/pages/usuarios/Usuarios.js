      ...
      <div className="modal-dialog modal-md">
        ...
        <div className="modal-content">
          ...
          <p ref={errRef} className={errMsg ? "errmsg" : "offscreen"} aria-live="assertive">{errMsg}</p>
            ...
            <div className="form-group mb-3">
              ...
              <input type="text" name="nombre" required className="form-control textbox-form" placeholder="Nombre del Usuario" aria-describedby="helpId"              
              onChange={handleChange("nombre")}>
              </input>
            </div>
            <div className="form-group mb-3">
              <label htmlFor="" className="form-label">Email</label>
              <input type="text" name="email" required className="form-control textbox-form" placeholder="email" aria-describedby="helpId"
        ...
        <option value="Usuario">Usuario</option>
            ...
            <div className="form-group">
              ...
              <input type="password" name="password" required  className="form-control textbox-form" placeholder="Password" aria-describedby="helpId"
