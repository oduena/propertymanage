...
const loadProyectos = async () => {
        ...
        const response = await axiosInstace.get('/proyectos/dashboard');
        setProyectos(response.data);
};

const loadProveedores = async () => {
    //const response = await Axios.get('http://localhost:3005/api/proveedores/dashboard');
    const response = await axiosInstace.get('/proveedores/dashboard');
...
const loadTotalProyectos = async () => {
    ...
    const response = await axiosInstace.get('/proyectos/dashboard/totalproyectos');
...
const loadTotalMantenimientosThisMonth = async () => {
    ...
    const response = await axiosInstace.get('/mantenimientos/dashboard/totalmantenimientos');
...
const loadTotalTareas = async () => {
    ...
    const response = await axiosInstace.get('/tareas/dashboard/porcentajecompletadas');
